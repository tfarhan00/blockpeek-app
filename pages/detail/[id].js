...
export default function Detail({ coin }) {
  ...
  return (
   ...
   <div className="w-[100%] flex flex-col items-center font-DM">
    ...
    <div className="flex flex-col h-[13rem] rounded-md px-5 items-center bg-white justify-center">
    ...
    <div className="flex flex-col h-[13rem] bg-white rounded-md p-4 justify-evenly items-center grow text-[13px] overflow-hidden md:justify-between md:text-[16px] whitespace-nowrap">
    ...
    <div id="secondCard" className="w-[22rem] h-[7rem] bg-white p-5 mt-2 flex justify-between font-DM font-bold overflow-hidden rounded-md text-[12px] md:w-[26rem]">
    ...
    <div id="thirdCard" className="w-[22rem] h-[10rem] bg-white mt-2 flex items-center font-DM font-bold overflow-hidden rounded-md md:w-[26rem]">
